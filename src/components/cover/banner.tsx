  ...
  return (
    <div className="pt-[52px]">
      <div className="flex w-[383px] flex-col justify-center items-start gap-2.5">
        ...
        <button className="flex items-center justify-center w-40 h-[90.182px] border-[#521210] rounded-2xl border-[5px] bg-[#250807] hover:bg-[#391d1a] transition-all ease-in-out cursor-meerkat">
