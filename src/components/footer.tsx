...
const Footer = () => {
  ...
  return (
    <footer className="cursor-meerkat relative w-[1440px] h-[768px] shrink-0 bg-no-repeat bg-[url('./assets/images/FOOTER_IMG2.svg')]">
      {/* TOP ILUSTRATION */}
      ...
      <div className="inline-flex w-[463px] h-[330px] pl-20 pt-[275px] shrink-0 flex-col items-start gap-[104px]">
        ...
        <div className="flex h-px flex-col justify-center items-start self-stretch">
          <p className="w-[463px] font-neueMontreal text-white font-medium leading-[27px] tracking-[0.16px]">
            Disclaimer: <br /> Meerkat was made for a fan and has no value. Don't risk money you are afraid of losing. The price may go up or it may go down. We
