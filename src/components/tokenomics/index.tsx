      ...
      <div ref={sectionRef} className="relative flex w-[1281px] h-[469px] shrink-0 justify-center items-center pb-[5px]">
        ...
        <div className="absolute left-[144px] bottom-[0px] flex w-[195.617px] h-16 items-start gap-1 px-4 py-3.5 border border-[#521210] rounded-2xl bg-[#250807]">
          <div className="flex flex-col justify-between items-center flex-[1_0_0] self-stretch">
            ...
            <span className="self-stretch font-neueMontreal text-[#FFEFD4] text-sm font-bold leading-[14px] tracking-[0.14px]">450M Tokens</span>
          </div>
          <span className="flex w-[47px] flex-col justify-center shrink-0 self-stretch font-newTitle text-[#FFEFD4] text-5xl font-bold leading-[48px]">
            7.5%
          </span>
        </div>
        <div className="absolute right-[144px] bottom-[0px] flex w-[195.617px] h-16 items-start gap-1 px-4 py-3.5 border border-[#521210] rounded-2xl bg-[#250807]">
          <div className="flex flex-col justify-between items-center flex-[1_0_0] self-stretch">
            ...
            <span className="self-stretch font-neueMontreal text-[#FFEFD4] text-sm font-bold leading-[14px] tracking-[0.14px]">300M Tokens</span>
          </div>
          <span className="flex w-[47px] flex-col justify-center shrink-0 self-stretch font-newTitle text-[#FFEFD4] text-5xl font-bold leading-[48px]">5%</span>
        </div>
        ...
        <div className="absolute left-[90px] top-[146px] flex w-[195.617px] h-16 items-start gap-1 px-4 py-3.5 border border-[#521210] rounded-2xl bg-[#250807]">
          <div className="flex flex-col justify-between items-center flex-[1_0_0] self-stretch">
            <span className="self-stretch font-neueMontreal text-[#FFEFD4] text-[10px]  leading-3 tracking-[0.1px]">Marketing:</span>
            <span className="self-stretch font-neueMontreal text-[#FFEFD4] text-sm font-bold leading-[14px] tracking-[0.14px]">600M Tokens</span>
          </div>
          <span className="flex w-[47px] flex-col justify-center shrink-0 self-stretch font-newTitle text-[#FFEFD4] text-5xl font-bold leading-[48px]">
            10%
          </span>
        ...
        <div className="absolute right-[360px] top-[0px] flex w-[195.617px] h-16 items-start gap-1 px-4 py-3.5 border border-[#521210] rounded-2xl bg-[#250807]">
          <div className="flex flex-col justify-between items-center flex-[1_0_0] self-stretch">
            ...
            <span className="self-stretch font-neueMontreal text-[#FFEFD4] text-sm font-bold leading-[14px] tracking-[0.14px]">2.4B Tokens</span>
          </div>
          <span className="flex w-[47px] flex-col justify-center shrink-0 self-stretch font-newTitle text-[#FFEFD4] text-5xl font-bold leading-[48px]">
            40%
          </span>
