        ...
        <div className="flex flex-col items-start gap-8 self-stretch px-0 py-8">
          ...
          <div className="flex px-3 flex-col items-center gap-[13.81px]">
            <div className="flex flex-col items-start self-stretch">
              <div className="flex flex-col items-center gap-[13.81px] self-stretch pt-[17.263px] pb-[13.81px] px-[13.81px] border-t-[#EEE7E7] border-r-[#EEE7E7] border-l-[#EEE7E7] rounded-[24px_24px_0px_0px] border-t-[0.863px] border-x-[0.863px] bg-presalecover">
