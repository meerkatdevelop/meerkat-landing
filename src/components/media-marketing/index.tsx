...
const MediaMarketing = () => {
  return (
    <section className="cursor-meerkat flex flex-col w-[1440px] justify-center items-center  bg-[#250807] px-20 py-28">
        ...
        <div className="flex items-start gap-6 self-stretch">
          <div className="flex h-[344px] flex-col items-start gap-4 flex-[1_0_0] pt-4 pb-6 px-4 border border-[#521210] rounded-3xl bg-[#521210]">
            ...
            <div className="flex w-96 flex-col items-start gap-2 px-2 py-0">
              <h5 className="self-stretch font-neueMontreal text-[#FFEFD4] text-2xl font-medium leading-6 tracking-[0.24px]">Titulo</h5>
              <div className="flex items-start gap-2 self-stretch">
                <span className="font-neueMontreal text-[#FFEFD4] text-sm leading-[normal]">Creador: {'Nombre del creador'}</span>
              </div>
            </div>
          </div>
          <div className="flex h-[344px] flex-col items-start gap-4 flex-[1_0_0] pt-4 pb-6 px-4 border border-[#521210] rounded-3xl bg-[#521210]">
