...
const LanguageSelectorMobile = ({ language, handleLanguage, search, setSearch }: LanguageSelectorProps) => {
  const handleSearch = () => {
  ...
  return (
    <motion.div
      ...
      animate="visible"
      exit="exit"
      className="absolute top-[100px] right-0 flex w-[258px] h-[460px] flex-col justify-start items-start gap-4 p-6 shadow-[1px_2px_13px_0px_rgba(0,0,0,0.30)] rounded-3xl bg-[#250807] overflow-hidden"
    >
